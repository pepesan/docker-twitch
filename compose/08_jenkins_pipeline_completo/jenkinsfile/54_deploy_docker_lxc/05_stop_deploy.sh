...
ssh -i ./config/ssh/id_ed25519 -o ConnectTimeout=2 -o ConnectionAttempts=1 -o StrictHostKeyChecking=no root@10.207.154.80 "docker rm -f demo-lxc-app 2>/dev/null || true"
echo "Despliegue 'demo-lxc-app' en LXC parado y eliminado."
