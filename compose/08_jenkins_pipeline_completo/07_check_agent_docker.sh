#!/bin/bash
# Comprueba que el nodo 'agent2' (el agente con Docker) aparece online en
# el Jenkins controller.
set -e
cd "$(dirname "$0")"
...
echo "Revisa 'docker logs jenkins_docker_pipeline_agent_docker' y"
